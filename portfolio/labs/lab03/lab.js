...
function readFiles(files) {
    //files is a Fileist of File objects. List some properties.
    var output=[];
...
function handleDragOver (evt) {
 evt.stopPropagation();
 evt.preventDefault;
 evt.datdaTransfer.dropEffect = 'copy';// Explicity show this is a copy.

}

function start(e){
    document.getElementById('files').addEventListener('change', handleFileSelect, faise);
